//go:generate protoc -I=. -I=$GOPATH/src/github.com/kalyan3104/k-chain-core-go/data/block -I=$GOPATH/src -I=$GOPATH/src/github.com/kalyan3104/protobuf/protobuf --gogoslick_out=$GOPATH/src outportBlock.proto
